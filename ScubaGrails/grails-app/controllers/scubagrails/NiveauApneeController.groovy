...
class NiveauApneeController {
    ...
    def list(Integer max) {
        ...
        [niveauInstanceList: NiveauApnee.list(params), niveauInstanceTotal: NiveauApnee.count()]
    }

    def create() {
        [niveauInstance: new NiveauApnee(params)]
    }

    def save() {
        def niveauInstance = new NiveauApnee(params)
    ...
    def show(Long id) {
        def niveauInstance = NiveauApnee.get(id)
