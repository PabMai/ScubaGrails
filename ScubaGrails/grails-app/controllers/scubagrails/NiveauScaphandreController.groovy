...
class NiveauScaphandreController {
    ...
    def list(Integer max) {
        ...
        [niveauInstanceList: NiveauScaphandre.list(params), niveauInstanceTotal: NiveauScaphandre.count()]
    }

    def create() {
        [niveauInstance: new NiveauScaphandre(params)]
    }

    def save() {
        def niveauInstance = new NiveauScaphandre(params)
    ...
    def show(Long id) {
        def niveauInstance = NiveauScaphandre.get(id)
