	...
	<body>
		...
		<g:if test="${session?.user?.admin}">
			...
			<ul>
				...
				<li><g:link class="create" action="create"><g:message code="niveauScaphandre.new.label"/></g:link></li>
			</ul>
		</div>
		<div id="show-niveau" class="content scaffold-show" role="main">
			<h1>Niveau Scaphandre <g:fieldValue bean="${niveauInstance}" field="niveau"/></h1>
