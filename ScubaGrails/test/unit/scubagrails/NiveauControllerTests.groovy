...
@TestFor(NiveauController)
@Mock(Niveau)
class NiveauControllerTests {
    ...
    void testDelete() {
        ...
        assert Niveau.count() == 0
        assert Niveau.get(niveau.id) == null
        assert response.redirectedUrl == '/niveau/list'
    }
}
